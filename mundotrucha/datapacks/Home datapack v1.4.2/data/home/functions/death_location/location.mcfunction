...
execute as @s[tag=death_location_tp] at @s if score @s death_l_enabled matches 1 if score @s death_l_r matches 1 run summon armor_stand ~ ~ ~ {Rotation:[180f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"death_location_tp\"}"}
execute as @s[tag=death_location_tp] at @s if score @s death_l_enabled matches 1 if score @s death_l_r matches 2 run summon armor_stand ~ ~ ~ {Rotation:[270f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"death_location_tp\"}"}
execute as @s[tag=death_location_tp] at @s if score @s death_l_enabled matches 1 if score @s death_l_r matches 3 run summon armor_stand ~ ~ ~ {Rotation:[0f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"death_location_tp\"}"}
execute as @s[tag=death_location_tp] at @s if score @s death_l_enabled matches 1 if score @s death_l_r matches 4 run summon armor_stand ~ ~ ~ {Rotation:[90f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"death_location_tp\"}"}

#Id link
execute as @s[tag=death_location_tp] at @s run scoreboard players operation @e[type=minecraft:armor_stand,name=death_location_tp,distance=..2,limit=1] home_id = @s home_id

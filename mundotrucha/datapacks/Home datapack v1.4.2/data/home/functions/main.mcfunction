...
##Home##
execute as @a[scores={home=..-1,home_cooldown=0}] run function home:home/tp
execute as @a[scores={home=..-1,home_cooldown=1..}] run function home:home/cooldown_message
execute as @a[scores={home=1..,home_cooldown=0}] run function home:home/tp
execute as @a[scores={home=1..,home_cooldown=1..}] run function home:home/cooldown_message
...
##Death_location##
execute as @a[scores={death_location=..-1,home_cooldown=0}] run function home:death_location/location
execute as @a[scores={death_location=..-1,home_cooldown=1..}] run function home:home/cooldown_message
execute as @a[scores={death_location=1..,home_cooldown=0}] run function home:death_location/location
execute as @a[scores={death_location=1..,home_cooldown=1..}] run function home:home/cooldown_message

##Back##
execute as @a[scores={back=..-1,home_cooldown=0}] run function home:back/tp
execute as @a[scores={back=..-1,home_cooldown=1..}] run function home:home/cooldown_message
execute as @a[scores={back=1..,home_cooldown=0}] run function home:back/tp
execute as @a[scores={back=1..,home_cooldown=1..}] run function home:home/cooldown_message

...
##Back##
#Coords
execute if score @s home_tp matches 1 if score @s back_enabled matches 1 store result score @s back_x run data get entity @s Pos[0]
execute if score @s home_tp matches 1 if score @s back_enabled matches 1 store result score @s back_y run data get entity @s Pos[1]
execute if score @s home_tp matches 1 if score @s back_enabled matches 1 store result score @s back_z run data get entity @s Pos[2]

#Dimension
scoreboard players reset @s back_d
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[nbt={Dimension:"minecraft:overworld"}] run scoreboard players set @s back_d 0
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[nbt={Dimension:"minecraft:the_nether"}] run scoreboard players set @s back_d 1
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[nbt={Dimension:"minecraft:the_end"}] run scoreboard players set @s back_d 2
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 unless score @s back_d matches 0.. run scoreboard players set @s back_d 3

#Head rotation
scoreboard players reset @s back_r
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[y_rotation=135..225] run scoreboard players set @s back_r 1
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[y_rotation=226..315] run scoreboard players set @s back_r 2
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[y_rotation=316..360] run scoreboard players set @s back_r 3
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[y_rotation=0..45] run scoreboard players set @s back_r 3
execute if score @s back_enabled matches 1 if score @s home_tp matches 1 if entity @s[y_rotation=46..134] run scoreboard players set @s back_r 4
...
##Armor stand##
execute as @s at @s if score @s home_tp matches 1 if score @s home_r matches 1 run summon armor_stand ~ ~ ~ {Rotation:[180f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"home_tp\"}"}
execute as @s at @s if score @s home_tp matches 1 if score @s home_r matches 2 run summon armor_stand ~ ~ ~ {Rotation:[270f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"home_tp\"}"}
execute as @s at @s if score @s home_tp matches 1 if score @s home_r matches 3 run summon armor_stand ~ ~ ~ {Rotation:[0f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"home_tp\"}"}
execute as @s at @s if score @s home_tp matches 1 if score @s home_r matches 4 run summon armor_stand ~ ~ ~ {Rotation:[90f],Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"{\"text\":\"home_tp\"}"}

execute as @s at @s run scoreboard players operation @e[type=minecraft:armor_stand,name=home_tp,distance=..2,limit=1] home_id = @s home_id
